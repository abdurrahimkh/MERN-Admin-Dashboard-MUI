...
const Products = () => {
  ...
  return (
    <Box m='1.5rem 2.5rem'>
      ...
      {data || !isLoading ? (
        <Box mt='20px' display='grid' gridTemplateColumns='repeat(4,minmax(0,1fr))' justifyContent='space-between' rowGap='20px' columnGap='1%' sx={{ '& > div': { gridColumn: isNonMobile ? undefined : 'span 4' } }}>
