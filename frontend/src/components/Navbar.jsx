...
const Navbar = ({ user, isSidebarOpen, setIsSidebarOpen }) => {
  ...
  const handleDropDown = e => setAnchorEl(e.currentTarget);
  ...
  return (
    ...
    >
      <Toolbar sx={{ justifyContent: 'space-between' }}>
        ...
        {/* Toggle theme and Settings icons */}
        <FlexBetween gap='1.5rem'>
          ...
          <FlexBetween>
            <Button onClick={handleDropDown} sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', textTransform: 'none', gap: '1rem' }}>
